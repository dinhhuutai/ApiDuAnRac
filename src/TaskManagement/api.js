...
// --- Quản lý dự án (mở rộng): dashboard, activity, tasks filter, workflow, CRUD project an toàn đường dẫn ---
const registerProjectManagementExtended = require('./projectManagementExtended');
registerProjectManagementExtended(router, { requireAuth, ensureProjectAccess });
